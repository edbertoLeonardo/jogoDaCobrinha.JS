...
function comida(){
    ...
    context.fillRect(posicaoComida.x, posicaoComida.y, box, box);
}
...
function iniciarJogo(){
    ...
    if (snakeX != posicaoComida.x || snakeY != posicaoComida.y){
        snake.pop();
    } else{posicaoComida.x = Math.floor(Math.random() * 15 + 1) * box;
         posicaoComida.y = Math.floor(Math.random() * 15 + 1) * box;
